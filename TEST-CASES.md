...
- [ ] Create, Create again [FAIL]
- [ ] Create, Start [FAIL]
- [ ] Create, Join, Start [FAIL]
- [ ] Create, at least 3 Join, Start [SUCCESS]

## Special

- [ ] Create, delete bot message, Create again [FAIL], Delete (command), Create again [SUCCESS]
